        ...
        <main>
          <Card mt={[30, 50]}>
            <Flex width={1} justifyContent={"space-between"}>
              ...
              <DefaultButton onClick={id => selectAudit("")}>
                <LeftArrowCircle size={16} /> Return
              </DefaultButton>
            </Flex>
            <SubHeading>
              <ClipboardList size={24} /> Vitals
            </SubHeading>
            ...
            <SubHeading>
              <File size={24} /> Documents
            </SubHeading>
            <Text mb={4}>
              There are currently no documents assigned to this audit. You can
              add one using the editor below.
            </Text>
            <Box>
              <DocumentEditor />
            </Box>
